...
/* ===================================================================== */
/* Register frame passed to syscall handler */
/* ===================================================================== */
...
/**
 * syscall_init - Initialize system call handling
 */
void syscall_init(void);

/**
 * handle_syscall - Handle a system call
 * @regs: Pointer to saved registers
 * 
...
/**
 * handle_sync_exception - Handle synchronous exception
 * @regs: Pointer to saved registers
 */
